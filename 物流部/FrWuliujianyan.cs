...
{
    public partial class FrWuliujianyan : Office2007Form
    {
        public FrWuliujianyan()
        {
        ...
        private void FrWuliujianyan_Load(object sender, EventArgs e)
        {
            Reload();
        ...
        public void Reload()
        {
            ...
            string sql1 = "select  id,工作令号,项目名称,设备名称,时间,流程类型,创建人,创建时间,到货验收流程标记,流程状态 from  tb_zongliucheng  where  流程状态='到达物流部'";
        ...
        private void 查看对应晓丹ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dataGridViewX1.Rows.Count <= 0)//判断是否选中要删除的行
            {
                MessageBox.Show("请选中行！");
        ...
        private void 处理流程ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Frliuchenghuifu form = new Frliuchenghuifu();
            form.gongzuolinghao = gonglinghao;
            form.xiangmumingcheng = xiangmumingcheng;
            form.yonghu = yonghu;
            form.shijian = shijian;
