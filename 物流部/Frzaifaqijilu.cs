...
{
    public partial class Frzaifaqijilu : Form
    {
        public Frzaifaqijilu()
        {
            InitializeComponent();
        }
        ...
        public DataTable dt;
        private void Frzaifaqijilu_Load(object sender, EventArgs e)
        {
        ...
        {
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "自检报告名称")) == "")
            {
                MessageBox.Show("没有自检报告！");
                return;
            }
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "自检报告名称")) != "")
            {
                ...
                string sql = "select 自检报告名称 from tb_daohuojilu where id='" + id + "'";
                string mingcheng = SQLhelp.ExecuteScalar(sql, CommandType.Text).ToString();
                if (mingcheng == "")
                {
                    MessageBox.Show("没有自检报告！");
                ...
                string sql2 = "select 自检报告类型 from tb_daohuojilu where id='" + id + "'";
                string leixing = SQLhelp.ExecuteScalar(sql2, CommandType.Text).ToString();

                byte[] mypdffile = null;

                string sql4 = "Select 自检报告 From tb_daohuojilu Where id='" + id + "' ";
                mypdffile = SQLhelp.duqu(sql4, CommandType.Text);
                this.Cursor = Cursors.WaitCursor;
        ...
        {
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "验收图纸名称")) == "")
            {
                MessageBox.Show("没有验收图纸！");
                return;
            }
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "验收图纸名称")) != "")
            {
                ...
                string sql = "select 验收图纸名称 from tb_daohuojilu where id='" + id + "'";
                string mingcheng = SQLhelp.ExecuteScalar(sql, CommandType.Text).ToString();
                if (mingcheng == "")
                {
                    MessageBox.Show("没有验收图纸！");
                ...
                string sql2 = "select 验收图纸类型 from tb_daohuojilu where id='" + id + "'";
                string leixing = SQLhelp.ExecuteScalar(sql2, CommandType.Text).ToString();

                byte[] mypdffile = null;

                string sql4 = "Select 验收图纸 From tb_daohuojilu Where id='" + id + "' ";
                mypdffile = SQLhelp.duqu(sql4, CommandType.Text);
                this.Cursor = Cursors.WaitCursor;
        ...
        {
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "检验员附件名称")) == "")
            {
            ...
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "检验员附件名称")) != "")
            {
                ...
                string sql = "select 检验员附件名称 from tb_daohuojilu where id='" + id + "'";
                string mingcheng = SQLhelp.ExecuteScalar(sql, CommandType.Text).ToString();
                if (mingcheng == "")
                {
                    MessageBox.Show("没有附件！");
                ...
                string sql2 = "select 检验员附件类型 from tb_daohuojilu where id='" + id + "'";
                string leixing = SQLhelp.ExecuteScalar(sql2, CommandType.Text).ToString();

                byte[] mypdffile = null;

                string sql4 = "Select 检验员附件 From tb_daohuojilu Where id='" + id + "' ";
                mypdffile = SQLhelp.duqu(sql4, CommandType.Text);
                this.Cursor = Cursors.WaitCursor;
        ...
        {
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "质监员附件名称")) == "")
            {
                MessageBox.Show("没有附件！");
                return;
            }
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "质监员附件名称")) != "")
            {
                ...
                string sql = "select 质监员附件名称 from tb_daohuojilu where id='" + id + "'";
                string mingcheng = SQLhelp.ExecuteScalar(sql, CommandType.Text).ToString();
                if (mingcheng == "")
                {
                    MessageBox.Show("没有附件！");
                ...
                string sql2 = "select 质监员附件类型 from tb_daohuojilu where id='" + id + "'";
                string leixing = SQLhelp.ExecuteScalar(sql2, CommandType.Text).ToString();

                byte[] mypdffile = null;

                string sql4 = "Select 质监员附件 From tb_daohuojilu Where id='" + id + "' ";
                mypdffile = SQLhelp.duqu(sql4, CommandType.Text);
                this.Cursor = Cursors.WaitCursor;
        ...
        {
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "不合格审批附件名称")) == "")
            {
                MessageBox.Show("没有附件！");
                return;
            }
            if (Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, "不合格审批附件名称")) != "")
            {
                ...
                string sql = "select 不合格审批附件名称 from tb_daohuojilu where id='" + id + "'";
                string mingcheng = SQLhelp.ExecuteScalar(sql, CommandType.Text).ToString();
                if (mingcheng == "")
                {
                    MessageBox.Show("没有附件！");
                ...
                string sql2 = "select 不合格审批附件类型 from tb_daohuojilu where id='" + id + "'";
                string leixing = SQLhelp.ExecuteScalar(sql2, CommandType.Text).ToString();

                byte[] mypdffile = null;

                string sql4 = "Select 不合格审批附件 From tb_daohuojilu Where id='" + id + "' ";
                mypdffile = SQLhelp.duqu(sql4, CommandType.Text);
                this.Cursor = Cursors.WaitCursor;
