...
{
    public partial class Frgudingzichanjilu : DevExpress.XtraEditors.XtraForm
    {
        public Frgudingzichanjilu()
        {
            InitializeComponent();
        }
        ...
        private void Frgudingzichanjilu_Load(object sender, EventArgs e)
        {
