...
{
    public partial class FrFankuineirong : Office2007Form
    {
        public FrFankuineirong()
        {
        ...
        private void FrFankuineirong_Load(object sender, EventArgs e)
        {
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            string sql2 = "update tb_jishubumen  set 技术要求反馈内容 ='" + richTextBoxEx1.Text + "' where 工作令号='" + gongzuolinghao + "' and 项目名称='" + xiangmumingcheng + "'and 时间='" + shijian + "'   "; 
