...
namespace 项目管理系统.仓库
{
    public partial class Frshoudongtuiku : Office2007Form
    {
        public Frshoudongtuiku()
        {
        ...
        string kucun;
        private void Frshoudongtuiku_Load(object sender, EventArgs e)
        {
            shijichuhuo = "";
            shijicaigou = "";
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            if (id != "")
            {
                ...
                string sql = "update tb_caigouliaodan set 出库数量='" + shijichuku + "', 库存数量='"+ kucunshuliang + "'  where id='" + id + "'";
