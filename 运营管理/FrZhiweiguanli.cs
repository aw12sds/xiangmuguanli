...
{
    public partial class FrZhiweiguanli : Office2007Form
    {
        public FrZhiweiguanli()
        {
            this.EnableGlass = false;
            InitializeComponent();
        }

        private void FrZhiweiguanli_Load(object sender, EventArgs e)
        {
            Reload();
        }
        public void Reload()
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridViewX2.Rows.Count > 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string code = dataGridViewX2.CurrentRow.Cells["职位"].Value.ToString();

                    string strSql1 = "delete from tb_zhiwei where  职位= '" + code + "' ";
