...
{
    public partial class FrTiaoshixiangqing : Office2007Form
    {
        public FrTiaoshixiangqing()
        {
        ...
        private void FrTiaoshixiangqing_Load(object sender, EventArgs e)
        {
            Reload();
        }
        public void Reload()
        ...
        {
            FrTiaoshihuifu form = new FrTiaoshihuifu();
