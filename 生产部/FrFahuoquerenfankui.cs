...
{
    public partial class FrFahuoquerenfankui : Office2007Form
    {
        public FrFahuoquerenfankui()
        {
        ...
        public string zhonglei;
        private void FrFahuoquerenfankui_Load(object sender, EventArgs e)
        {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("确认重新发起吗？", "软件提示", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        string sql4 = "update tb_zongliucheng  set 流程状态='到达技术部'  where id='" + id1 + "' ";
...

            {
                ...
                if (MessageBox.Show("确认继续吗？", "软件提示", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
                {
                    DateTime huifu = DateTime.Now;
