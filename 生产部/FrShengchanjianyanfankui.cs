...
{
    public partial class FrShengchanjianyanfankui : Office2007Form
    {
        public FrShengchanjianyanfankui()
        {
        ...
        private void FrShengchanjianyanfankui_Load(object sender, EventArgs e)
        {
