...
{
    public partial class FrFahuoquerenzongliucheng : Office2007Form
    {
        public FrFahuoquerenzongliucheng()
        {
        ...
        private void FrFahuoquerenzongliucheng_Load(object sender, EventArgs e)
        {
            string sql1 = "select  id,设备名称,项目名称,工作令号,时间,流程类型,创建人,创建时间,流程内容,附件名称,流程标记,附件类型 from  tb_liuchengxiangxi  where 工作令号='" + gongzuolinghao + "' and 项目名称='" + xiangmumingcheng + "'and 时间='" + shijian + "'  and 流程类型='发货确认流程' ";
