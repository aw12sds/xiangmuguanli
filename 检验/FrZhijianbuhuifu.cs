...
namespace 项目管理系统.检验
{
    public partial class FrZhijianbuhuifu : Office2007Form
    {
        public FrZhijianbuhuifu()
        {
        ...
        public string zhonglei;
        private void FrZhijianbuhuifu_Load(object sender, EventArgs e)
        {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            if (zhonglei == "到货验收")
            {
                ...
                {
                    if (MessageBox.Show("确认通过吗？", "软件提示", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
                    {
                        ...
                        try
                        {
                            ...
                            string sql41 = "update tb_caigouliaodan  set 流程状态='到达仓库' where  工作令号='" + gongzuolinghao + "' and  项目名称='" + xiangmumingcheng + "'  and  设备名称='" + shebeimingcheng + "' and  到货验收流程标记='" + biaoji + "'";
