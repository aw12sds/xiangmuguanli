...
namespace 项目管理系统
{
    public partial class FrJianyan : Office2007Form
    {
        ...
        public void Reload()
        {
            ...
            string sql1 = "select  id,工作令号,项目名称,设备名称,时间,流程类型,创建人,创建时间,到货验收流程标记,流程状态 from  tb_zongliucheng  where  流程状态='到达质监部' and 流程类型='到货验收流程'";
            DataTable dt = SQLhelp.GetDataTable(sql1, CommandType.Text);
            dataGridViewX1.DataSource = dt;

            string sql2= "select  id,工作令号,项目名称,设备名称,时间,流程类型,创建人,创建时间,发货确认流程标记,流程状态 from  tb_zongliucheng  where  流程状态='到达质监部' and 流程类型='发货确认流程'";
        ...
        private void FrJianyan_Load(object sender, EventArgs e)
        {
            Reload();
        }
        ...
        private void 处理流程ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FrZhijianbuhuifu form = new FrZhijianbuhuifu();
            form.gongzuolinghao = gonglinghao;
            form.xiangmumingcheng = xiangmumingcheng;
            form.yonghu = yonghu;
            form.shijian = shijian;
